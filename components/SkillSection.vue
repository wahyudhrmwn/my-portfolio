<template>
  ...
  <section id="skills" class="py-20 px-4 sm:px-6 lg:px-8">
    <div class="container mx-auto max-w-6xl">
      ...
      <div class="w-20 h-1 bg-yellow-400 mb-10"></div>
      ...
      >
        <!-- Next JS -->
        <div
          class="bg-gray-800 p-6 rounded-lg flex flex-col items-center justify-center h-32"
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/nextjs-icon.svg"
              alt="Next JS"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Next JS</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/nuxtjs-icon.svg"
              alt="Nuxt JS"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Nuxt JS</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/nestjs-icon.svg"
              alt="NestJS"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Nest JS</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/typescriptlang-icon.svg"
              alt="TypeScript"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">TypeScript</p>
        </div>
        ...
        <div
          class="bg-gray-800 p-6 rounded-lg flex flex-col items-center justify-center h-32"
        >
          <div class="text-3xl mb-2 flex">
            <img src="@/assets/svg/html5-icon.svg" alt="HTML" class="w-8 h-8" />
            <img src="@/assets/svg/css-icon.svg" alt="CSS" class="w-8 h-8" />
          </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/tailwindcss-icon.svg"
              alt="Tailwind CSS"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Tailwind CSS</p>
        </div>
        ...
        >
          ...
          <p class="text-sm text-center">My SQL</p>
        </div>
        ...
        >
          ...
          <p class="text-sm text-center">PostgreSQL</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/firebase-icon.svg"
              alt="Firebase"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Firebase</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/daisyui-icon.svg "
              alt="DaisyUI"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Daisy UI</p>
        </div>
        ...
        >
          ...
          <p class="text-sm text-center">Preline UI</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/git-scm-icon.svg"
              alt="Git"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Git</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/azure-icon.svg"
              alt="Azure"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Azure</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/jquery-icon.svg"
              alt="JQuery"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">JQuery</p>
        </div>
        ...
        >
          <div class="text-3xl mb-2">
            <img
              src="@/assets/svg/microsoft-icon.svg"
              alt="Microsoft"
              class="w-8 h-8"
            />
          </div>
          <p class="text-sm text-center">Microsoft</p>
        </div>
